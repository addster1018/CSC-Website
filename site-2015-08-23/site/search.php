...
<html lang="en">
  ...
  =========================================================-->
    ...
    <header class="head1">
            <div class="top-panel wow fadeInRight" data-wow-duration="1.5s">
                <div class="container">
                    <a href="callto:#" class="phone-icon">+1 800 559 6580</a>
                    <address>28 Jackson Blvd Ste 1020 Chicago</address>
                </div>
            </div>
                    ...
                    <div class="container">
                        <div class="navbar-header">
                            <h1 class="navbar-brand">
                                <a data-type='rd-navbar-brand' href="./">Icer</a>
                            </h1>
                        </div>
  ...
  =========================================================-->
  <footer>
          <section class="bot_sec bot_sec_mod center767">
              <div class="container">
                  <p class="rights">
                      Icer &#169; <span id="copyright-year"></span> &nbsp;|&nbsp;
